...
public class Project_Status_Gadget_19 extends LaunchBrowser{
	...
	String fileName="Project_Status_Gadget_19";
	...
	public void as_a_Tester_Launch_DashBoard_page() throws Throwable {
		try
	    {
			bp=new BasePage();
			...
			pp.clickOnLogout();
		     ...
		     String Pass=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH,"Tester_Password_1");
		     lp.enterUname(Uname);
		     lp.enterPass(Pass);
		     lp.clickOnLogin();
	...
	public void add_a_DashBoard_by_clicking_on_dashboard_plus_symbol() throws Throwable {
		try
		{
	...
	@When("^dashBoard is created$")
	public void dashboard_is_created() throws Throwable {
		try
		{
		String dashboardName=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "DashBoards", 8,37);
		String desc=Excel_Lib.getData(INPUT_PATH_3, "DashBoards", 1,3);
		String layout=Excel_Lib.getData(INPUT_PATH_3, "DashBoards", 1,4);
		String shareType=Excel_Lib.getData(INPUT_PATH_3, "DashBoards",3,5);
	...
	public void add_a_project_status_gadget_by_click_on_the_add_gadget_plus_symbol() throws Throwable {
		try
	    {
	    	String dashboardName=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "DashBoards", 8,37);
			...
			String projectName2=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH,"Normal_Project_3");
			actual[7]=dbp.configureProjectStatusGadget(projectName2);
			dbp.saveGadget();
			...
			dbp.configureProjectStatusGadget(projectName1);
			dbp.saveGadget();
	    }
	    catch(Exception e)
		{
	...
	public void login_as_Lead_Launch_DashBoard_page() throws Throwable {
	 try
	  {
	     lp=new LoginPage(driver);
	     String Uname=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH,"Tester_Username_2");
	     String Pass=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH,"Tester_Password_2");
	     lp.enterUname(Uname);
	     lp.enterPass(Pass);
	     lp.clickOnLogin();
	...
	public void should_not_be_able_to_delete_project_status_gadget() throws Throwable {
		try
	    {
			...
			actual[12]=dbp.validateDashBoard(dashboardName);
	        dbp.selectDashboard(dashboardName);
	        
	        String value=Excel_Lib.getData(INPUT_PATH_3, "DashBoards", 4,13);
			actual[13]=dbp.gadgetOperation(value);	       
