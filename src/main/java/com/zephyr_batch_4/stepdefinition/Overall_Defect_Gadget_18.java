...
public class Overall_Defect_Gadget_18 extends LaunchBrowser{
	...
	ExecutionPage exep;
	DashBoardPage dbp;
	String fileName="Overall_Defect_Gadget_18";
	
	boolean[] actual=new boolean[38];
	 SoftAssert soft=new SoftAssert();
	
	@Given("^Manager is in the Login page$")
	public void manager_is_in_the_Login_page() throws Throwable {
		try
	    {
			bp=new BasePage();
	...
	public void manager_logged_in_to_a_application_successfully() throws Throwable {
		try
		   {
		...
		try
		   {
			 ...
			 tr=new TestRepositoryPage(driver);
				String p_Name1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "DashBoards", 4, 28);
	...
	public void create_a_cycle_in_test_Planning() throws Throwable {
		try
		   {
			bp.waitForElement();
			  ...
			  tp=new TestPlanningPage(driver);
				...
				String cycle=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "DashBoards", 4, 30);
	...
	public void add_a_phase_by_choosing_an_existing_phase() throws Throwable {
		try
	    {
			...
			cycle[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "DashBoards", 4, 30);
			actual[16]=tp.navigateToCycle(cycle);
			
			bp.waitForElement();
			String Phase=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "DashBoards", 4, 28);
		...
		try
		   {
			   ...
			   String[] cycleName=new String[2];
			    String releaseName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH,"Release_5");
			    cycleName[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "DashBoards",4 ,30 );
			    cycleName[1]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "DashBoards",4 ,28 );
	...
	public void defects_linked_to_the_executions() throws Throwable {
		try
		   {
			   int testcase1=Excel_Lib.getNumberData(INPUT_PATH_3, "TestPlanning",1,19 );
			   exep.clickOnDefectButton(testcase1);
			   
			   String defectId1=Excel_Lib.getData(INPUT_PATH_3, "DashBoards",12 ,31 );
			   ...
			   String defectId2=Excel_Lib.getData(INPUT_PATH_3, "DashBoards",12 ,32 );
			   ...
			   String defectId3=Excel_Lib.getData(INPUT_PATH_3, "DashBoards",12,33 );
...
//			   actual[30]=exep.linkDefect(defectId5);
	...
	public void add_a_dashboard_by_clicking_on_plus_symbol() throws Throwable {
		...
		String dashboardName=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "DashBoards", 17,16);
	...
	public void select_project_release_and_referesh_rate_save_it() throws Throwable {
		try
		{
			 String projectName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH,"Normal_Project_4"); 
	...
	public void should_show_In_Progress_defect_count_properly() throws Throwable {
		try
		{
			String defectStatusName=Excel_Lib.getData(INPUT_PATH_3, "DashBoards", 12,30);  
			actual[37]=dbp.defectStatusCount(defectStatusName);
		}
	 catch(Exception e)
		{
		   lb=new LaunchBrowser();
