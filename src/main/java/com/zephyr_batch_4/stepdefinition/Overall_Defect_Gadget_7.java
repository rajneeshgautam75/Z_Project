...
public class Overall_Defect_Gadget_7 extends LaunchBrowser {
	LaunchBrowser lb;
	LoginPage lp;
	ProjectPage pp;
	BasePage bp;
	...
	public void user_adds_the_dashboard_by_clicking_on_plus_button() throws Throwable {
		try
		   {
	...
	public void user_Clicks_On_an_Added_Dashboard() throws Throwable {
		try
		{
	...
	public void should_be_Able_to_select_dashboard_which_added() throws Throwable {
		try
		{
			String dashBoard=UNIQUE+Excel_Lib.getData(INPUT_PATH_7,"AddDashboard", 13, 1);
			bp.waitForElement();
	...
	public void should_be_able_to_add_an_Overall_Defect_Gadget() throws Throwable {
		try
		{
			String gadgetName=Excel_Lib.getData(INPUT_PATH_7,"AddDashboard", 5, 6);
			bp.waitForElement();
	...
	public void should_be_possible_to_save_Overall_Defect_Gadget() throws Throwable {
		try
	    {
			String projectName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH,"Normal_Project_1");
	    	String release=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH, "Release_1");
