	  ...
	  try
	  {
		  pp=new ProjectPage(driver);
		   bp=new BasePage();
		    ...
		    String managerUname=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH, "Manager_Username_1");
		    String managerPass=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH, "Manager_Password_1");
...
//			  
			  ...
			  pp.clickOnLogout();
			    lp=new LoginPage(driver);
			    String leadUname=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH, "Lead_Username_1");
			    String leadPass=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_DASH, "Lead_Password_1");
	...
	public void create_a_new_defect() throws Throwable {
		...
		if(res==false)
		{
		exe.createDefect(project,issueType);
