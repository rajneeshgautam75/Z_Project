...
public class Defect_Tracking_49 extends LaunchBrowser{
	...
	BasePage bp;
	DefectTracking dt;
	String fileName="Defect_Tracking_49";
	...
	public void user_search_the_defects_and_select_the_multiple_defects() throws Throwable {
		try
		   {
	...
	@When("^change single affected version to multiple affected version for the same project$")
	public void change_single_affected_version_to_multiple_affected_version_for_the_same_project() throws Throwable {
		try
		   {
			 ...
			 versionValue[0]=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking", 1,27);
			 versionValue[1]=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking", 2,27);
	...
	public void should_be_able_to_change_multiple_defects_from_single_affected_version_to_multiple_affected_version() throws Throwable {
		try
		   {
			 String version=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking", 7,20);
			 ...
			 actual[5]=dt.validateDefectVersions(version);
