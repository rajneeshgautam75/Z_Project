...
public class Defect_Tracking_136 extends LaunchBrowser{
	...
	DefectTracking dt;
	String fileName="Defect_Tracking_136";
	...
	@When("^User navigate to the affected version$")
	public void user_navigate_to_the_affected_version() throws Throwable {
	try
	   {
	...
	public void should_be_able_to_edit_the_affected_version_value() throws Throwable {
	try
	   {
	...
	public void create_a_defect_with_edited_affected_version_value() throws Throwable {
	try
	   {
			...
			String affets_Version=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",6,5);
			String desc=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking", 100,100);
		    actual[19]=dt.createDefect(project, issuetype);
			actual[20]=dt.fileNewDefect(summary,fields[0],fields[1],desc,fields[2],fields[3],fields[4],fields[5],fields[6],fields[7],fields[8],affets_Version,fields[9]);
	...
	public void should_be_able_to_create_defect_with_edited_affected_version_value() throws Throwable {
	try
	   {
		 String project=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking", 2,0);
		 String issuetype=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking", 1,2);
