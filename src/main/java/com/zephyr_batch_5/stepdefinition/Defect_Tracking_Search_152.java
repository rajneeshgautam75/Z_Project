...
public class Defect_Tracking_Search_152 extends LaunchBrowser{
	...
	TestPlanningPage tp;
	String fileName="Defect_Tracking_Search_152";
	...
	public void user_search_a_issue_with_not_equals_operator_using_JQL() throws Throwable {
	try
	   {
		 String selectSearch=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking", 1,9);
		 String value=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",8,36);
	...
	public void should_be_able_to_search_issues_with_equals_operator_using_JQL() throws Throwable {
	try
	   {
		 String defectType=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",3,1);
		 String defectValue=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",7,3);
	...
	public void user_launch_requirements_and_search_a_issue_with_equals_operator_using_JQL() throws Throwable {
	try
	   {
		 bp.waitForElement();
		 ...
		 String enterQuerry=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",8,36 );
	...
	public void should_be_able_to_Search_issue_not_equals_operator_using_JQL() throws Throwable {
	try
	   {
		 String defectType=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",3,1);
		 String defectValue=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",7,3);
	...
	@When("^search a issue with equals operator using JQL$")
	public void search_a_issue_with_equals_operator_using_JQL() throws Throwable {
	try
	   {
		 String selectSearch=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking", 1,9);
		 String value=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",8,36);
	...
	public void should_be_able_to_search_a_issue_not_equals_operator_using_JQL() throws Throwable {
	try
	   {
		 String defectType=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",3,1);
		 String defectValue=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",7,3);
