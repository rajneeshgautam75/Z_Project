...
public class External_JIRA_71 extends LaunchBrowser{
	
	LaunchBrowser lb=new LaunchBrowser();
	String fileName="External_JIRA_71";
	...
	String requirementNode=UNIQUE+Excel_Lib.getData(INPUT_PATH_5, "Req", 7, 4);
	...
	public void user_clicks_on_Import_option_and_Import_JIRA_requirement() throws Throwable {
		try
		{
	...
	public void folder_will_be_moved_to_local_tree() throws Throwable {
		try
		{
	...
	public void login_as_manager_and_enable_the_req_tc_flag_in_defect_admin_and_Logout() throws Throwable {
		try
		{
	...
	@When("^Login as Lead , navigate to Requirement Page and requirement$")
	public void login_as_Lead_navigate_to_Requirement_Page_and_requirement() throws Throwable {
		try
		{
	...
	@When("^Select requirement, click on Map button and map to single/multiple testcase$")
	public void select_requirement_click_on_Map_button_and_map_to_single_multiple_testcase() throws Throwable {
		try
		{
...
//			String password=Excel_Lib.getData(INPUT_PATH_5, "LogIn",1 ,1 );
	...
	@When("^check the req-testcase mapping remote link in External_JIRA$")
	public void check_the_req_testcase_mapping_remote_link_in_External_JIRA() throws Throwable {
		try
		{
			ej=new ExternalJiraPage(driver);
	...
	@When("^Click on testcase ID on that remote link$")
	public void click_on_testcase_ID_on_that_remote_link() throws Throwable {
	try
	{
	      actual[31]=ej.clickOnTestCaseIdInJira(id);
	      bp.waitForElement();
	}
	catch(Exception e)
	{
	...
	public void should_navigate_to_test_repository_search_window_and_search_for_that_testcase() throws Throwable {
		try
		{
		String testCaseName=Excel_Lib.getData(INPUT_PATH_5,"Req", 2,0);
		actual[32]=tr.validateTestCaseInSearch(testCaseName);
		driver.close();
		bp.switchWindowTab(tabNo0);
		bp.waitForElement();
		actual[33]=rp.clickOnGo();
		bp.waitForElement();
		bp.switchWindowTab(tabNo1);
		bp.waitForElement();
		actual[34]=ej.logOutFromExternal_JIRA();
		bp.waitForElement();
		driver.close();
		bp.waitForElement();
		bp.switchWindowTab(tabNo0);
