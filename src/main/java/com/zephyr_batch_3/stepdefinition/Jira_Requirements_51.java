...
public class Jira_Requirements_51 extends LaunchBrowser {
	...
	BasePage bp;
	ExportPage ep;
	String fileName = "Import_Jira_Requirements_51";

	boolean[] actual = new boolean[9];
	SoftAssert soft = new SoftAssert();

	@Given("^User is in Requirements App$")
	public void user_is_in_Requirements_App() throws Throwable {
		try {
			bp = new BasePage();
	...
	public void user_click_on_Import_button_and_User_select_Jira_Option() throws Throwable {
		try {
	...
	public void user_performs_JQL_operation_and_select_single_multiple_defect_requirements() throws Throwable {
		try {
			req = new RequirementsPage(driver);
	...
	public void should_be_able_to_import_selected_requirement() throws Throwable {
		try {
