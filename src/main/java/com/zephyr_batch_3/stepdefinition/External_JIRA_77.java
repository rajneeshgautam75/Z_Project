...
public class External_JIRA_77 extends LaunchBrowser {
	    LaunchBrowser lb=new LaunchBrowser();
	    String fileName="External_JIRA_77";
		...
		String requirementNode=UNIQUE+Excel_Lib.getData(INPUT_PATH_5, "Req", 13, 4);
	...
	public void login_as_Manager_enable_req_tc_flag_and_logout() throws Throwable {
		try
		{
		   ...
		   // actual[15]=ccf.EnableJiraLinkIssue(linkType);
...
//			String password=Excel_Lib.getData(INPUT_PATH_5, "LogIn",1 ,1 );
	...
	public void navigate_to_TestRepository_and_delete_the_testcase_node_mapped_to_JIRA_requirement() throws Throwable {
		try
		{
			rrp.clickOnTestRep();
			bp.waitForElement();
