...
public class External_JIRA_75 extends LaunchBrowser{
	
      LaunchBrowser lb=new LaunchBrowser();
	  String fileName="External_JIRA_75";
		...
		String requirementNode=UNIQUE+Excel_Lib.getData(INPUT_PATH_5, "Req", 11, 4);
...
//			String password=Excel_Lib.getData(INPUT_PATH_5, "LogIn",1 ,1 );
	...
	public void deallocate_the_req_node_which_is_having_req_mapped_to_testcases() throws Throwable {
		try
		{
			...
			actual[33]=rp.deleteOrDeallocateRequirementNode(deallocate);
			bp.waitForElement();
