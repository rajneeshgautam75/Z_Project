...
public class TestExecution_FreeForm_878833 extends LaunchBrowser{
	...
	boolean[] actual=new boolean[398];
	SoftAssert soft=new SoftAssert();
	
    String fileName="TestExecution_FreeForm_878833";
	...
	public void lead_creates_a_phase_system_and_ten_subsystems_and_add_ten_testcase_with_all_details_to_each_node() throws Throwable {
		try
	    {
					tr=new TestRepositoryPage(driver);
				String releaseName=Excel_Lib.getData(INPUT_PATH_3, "Releases", 6, 0);
				String p_Name1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 1);
				String p_Desc1=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 4);
				...
				String s_Name1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 2);
				String s_Desc1=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 5);
				bp.waitForElement();
    	  ...
    	  String ss_Name1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 3);
    	  String ss_Desc1=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 6);
    	 ...
    	 // actual[43]=tr.selectPhase(ss_Name1);
    	  ...
    	  tr.addTestCase();
			...
			actual[59]=tr.clickOnRelease(releaseName);
	    	 String ss_Name2=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 8);
	    	  String ss_Desc2=Excel_Lib.getData(INPUT_PATH_3, "FreeForm_878818", 40, 6);
	    	  ...
	    	  tr.addTestCase();
				...
				actual[78]=tr.clickOnRelease(releaseName);
		    	 String ss_Name3=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 9);
		    	  String ss_Desc3=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 6);
		    	  ...
		    	  tr.addTestCase();
					...
					actual[97]=tr.clickOnRelease(releaseName);
			    	 String ss_Name4=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 10);
			    	  String ss_Desc4=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 6);
	    	 ...
	    	 String ss_Name5=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 11);
	    	  String ss_Desc5=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 6);
	    	 ...
	    	 actual[119]=tr.navigateToNode(releaseName, str7);
	    	  tr.addTestCase();
				...
				actual[135]=tr.clickOnRelease(releaseName);
		    	 String ss_Name6=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 12);
		    	  String ss_Desc6=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 6);
		    	  ...
		    	  tr.addTestCase();
					...
					actual[154]=tr.clickOnRelease(releaseName);
			    	 String ss_Name7=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 13);
			    	  String ss_Desc7=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 6);
			    	  ...
			    	  tr.addTestCase();
						...
						actual[174]=tr.clickOnRelease(releaseName);
				    	 String ss_Name8=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 14);
				    	  String ss_Desc8=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 6);
				    	  ...
				    	  tr.addTestCase();
							...
							actual[193]=tr.clickOnRelease(releaseName);
					    	 String ss_Name9=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 15);
					    	  String ss_Desc9=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 6);
					    	  ...
					    	  tr.addTestCase();
								...
								actual[212]=tr.clickOnRelease(releaseName);
						    	 String ss_Name10=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 16);
						    	  String ss_Desc10=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 6);
	...
	public void lead_Launch_TestPlanning_and_create_a_cycle_and_create_a_phase_and_assign_testcases_to_a_tester() throws Throwable {
		try
		   {
			bp.waitForElement();
			  ...
			  tp=new TestPlanningPage(driver);
				...
				String cycle=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 0);
				...
				cycle1[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 0);
				actual[233]=tp.navigateToCycle(cycle1);
				
				 bp.waitForElement();
				String Phase=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 1);
				...
				cycle11[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 1);
				bp.waitForElement();
				...
				bp.waitForElement();
			     ...
			     cycle22[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 2);
				 tp.navigateToCycle(cycle22);
					...
					bp.waitForElement();
				     ...
				     cycle33[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 3);
				     bp.waitForElement();
					 tp.navigateToCycle(cycle33);
						...
						bp.waitForElement();
					     ...
					     cycle44[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 8);
					     bp.waitForElement();
						 tp.navigateToCycle(cycle44);
							...
							bp.waitForElement();
						     ...
						     cycle55[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 9);
						     bp.waitForElement();
							 tp.navigateToCycle(cycle55);
							    ...
							    cycle66[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 10);
							    bp.waitForElement();
						    ...
						    cycle77[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 11);
						    bp.waitForElement();
					    ...
					    cycle88[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 12);
					    bp.waitForElement();
				    ...
				    cycle99[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 13);
				    bp.waitForElement();
			    ...
			    cycle100[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 14);
			    bp.waitForElement();
		    ...
		    cycle101[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 15);
		    bp.waitForElement();
	    ...
	    cycle102[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 40, 16);
	    bp.waitForElement();
	...
	public void tester_Launch_TestExecution_and_execute_five_testcases_to_different_status_in_each_node() throws Throwable {
		try
		{
			/*pp=new ProjectPage(driver);//
			bp=new BasePage();
	    ...
	    cycleName1[1]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,0 );
	    cycleName1[2]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,1 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    cycleName2[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,2 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    cycleName3[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,3 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    cycleName4[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,8 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    cycleName5[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,9 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    cycleName6[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,10 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    cycleName7[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,11 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    cycleName8[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,12 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    cycleName9[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,13 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    cycleName10[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,14 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    cycleName11[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,15 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    cycleName12[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,16 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	...
	public void lead_Launch_TestPlanning_and_create_cycle_and_create_freeform_phase_and_create_a_node_to_freeform_phase() throws Throwable {
		try
	    {
			/*bp=new BasePage();
	    	pp=new ProjectPage(driver);
			...
			actual[314]=rp.clickOnTestPlanning();
			  ...
			  tp=new TestPlanningPage(driver);
				//String[] str=new String[4];
				String cycle=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 41, 0);
				String Build=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning", 2, 0);
				String environ=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning", 3, 0);
				String hide=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning", 100, 100);
				actual[315]=tp.clickOnAddTestCycleSymbol();
				bp.waitForElement();
				bp.waitForElement();
				actual[316]=tp.CreateCycle(cycle, Build, environ, hide);
				String syear=Integer.toString(Excel_Lib.getNumberData(INPUT_PATH_3, "TestPlanning", 1, 23));
				String smonth=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning", 10, 22);
				String sday=Integer.toString(Excel_Lib.getNumberData(INPUT_PATH_3, "TestPlanning", 1, 21));
				String eyear=Integer.toString(Excel_Lib.getNumberData(INPUT_PATH_3, "TestPlanning", 1, 26));
				...
				String eday=Integer.toString(Excel_Lib.getNumberData(INPUT_PATH_3, "TestPlanning", 1, 24));
				bp.waitForElement();
				actual[317]=tp.enterStartDatAndEndDate(syear, smonth, sday, eyear, emonth, eday);
				bp.waitForElement();
				actual[318]=tp.saveTestCycle();
				
			
			String[] cycle1=new String[1];
			cycle1[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 41, 0);
			bp.waitForElement();
			actual[319]=tp.navigateToCycle(cycle1);
			
			String phaseName=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 41, 1);
			actual[320]=tp.createFreeFormPhase(phaseName);
			bp.waitForElement();
			
			String[] cycle11=new String[1];
			cycle11[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 41, 1);
			bp.waitForElement();
			actual[321]=tp.navigateToCycle(cycle11);
			
			String systemName1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 42, 2);
			String systemDesc1=Excel_Lib.getData(INPUT_PATH_3, "FreeForm", 42, 5);
			bp.waitForElement();
			actual[322]=tp.addNode(systemName1, systemDesc1);
	    }
	    catch(Exception e)
		{
	    	lb.getScreenShot(fileName);
	...
	@When("^add testcases to freeform phase using other cycle and different status values$")
	public void add_testcases_to_freeform_phase_using_other_cycle_and_different_status_values() throws Throwable {
		try
	    {	
	    	String[] cycleName=new String[1];
		     cycleName[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",41 ,1 );
		     bp.waitForElement();
		     actual[323]=tp.navigateToCycle(cycleName);
		     
		     bp.waitForElement();
		     actual[324]=tp.clickOnAddTestcasesToFreeForm();
		     
		     bp.waitForElement();
		     actual[325]=tp.launchOtherCycles();
		     
		     
		     bp.waitForElement();
		     String cyclename1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,0 );
		     ...
		     bp.waitForElement();
		     actual[326]=tp.selectCycleInSearch(cyclename1, Build1, Environment1);
		     
		     bp.waitForElement();
		     String PhaseName1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,1 );
		     actual[327]=tp.selectPhaseInSearch(PhaseName1);
		     bp.waitForElement();
		     
		     String Status1=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning",1 ,18 );
		     actual[328]=tp.filterByStatus(Status1);
		     
		     actual[329]=tp.clickOnGo();
		     
		     actual[330]=tp.validateRetrieveTestcases();
		     bp.waitForElement();
		     
		     actual[331]=tp.clickOnMaintainassignmentsoforiginalschedules();
		     bp.waitForElement();
		     
		     //actual[332]=tp.selectAllFreeFormTestCases();//11/04/18
		     actual[332]=tp.selectAllFreeFormTestCasesPhase();
		     bp.waitForElement();
		     ...
		     actual[335]=tp.validateAddtestcaesToFreeForm();
		     bp.waitForElement();
		     ...
		     bp.waitForElement();
		     actual[337]=tp.launchOtherCycles();
		     
		     bp.waitForElement();
		     String cyclename2=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,0 );
		     ...
		     bp.waitForElement();
		     actual[338]=tp.selectCycleInSearch(cyclename2, Build2, Environment2);
		     
		     bp.waitForElement();
		     String PhaseName2=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,1 );
		     actual[339]=tp.selectPhaseInSearch(PhaseName2);
		     bp.waitForElement();
		     
		     String Status2=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning",2 ,18 );
		     actual[340]=tp.filterByStatus(Status2);
		     
		     actual[341]=tp.clickOnGo();
		     
		     actual[342]=tp.validateRetrieveTestcases();
		     bp.waitForElement();
		     
		     actual[343]=tp.clickOnMaintainassignmentsoforiginalschedules();
		     bp.waitForElement();
		     
		     actual[344]=tp.selectAllFreeFormTestCasesPhase();
		     bp.waitForElement();
		     
		     actual[345]=tp.clickOnSaveAndOk();
		     bp.waitForElement();
		     
		     actual[346]=tp.closeFreeFormPage();
		     bp.waitForElement();
		     
		     
		     actual[347]=tp.validateAddtestcaesToFreeForm();
		     bp.waitForElement();
		     
		     bp.waitForElement();
		     actual[348]=tp.clickOnAddTestcasesToFreeForm();
		     
		     bp.waitForElement();
		     actual[349]=tp.launchOtherCycles();
		     
		     bp.waitForElement();
		     String cyclename3=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,0 );
		     ...
		     actual[350]=tp.selectCycleInSearch(cyclename3, Build3, Environment3);
		     bp.waitForElement();
		     
		     bp.waitForElement();
		     String PhaseName3=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,1 );
		     actual[351]=tp.selectPhaseInSearch(PhaseName3);
		     bp.waitForElement();
		     
		     String Status3=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning",5 ,18 );
		     actual[352]=tp.filterByStatus(Status3);
		     
		     actual[353]=tp.clickOnGo();
		     
		     actual[354]=tp.validateRetrieveTestcases();
		     bp.waitForElement();
		     
		     actual[355]=tp.clickOnMaintainassignmentsoforiginalschedules();
		     bp.waitForElement();
		     
		     actual[356]=tp.selectAllFreeFormTestCasesPhase();
		     bp.waitForElement();
		     ...
		     actual[359]=tp.validateAddtestcaesToFreeForm();
		     bp.waitForElement();
		     
		     bp.waitForElement();
		     actual[360]=tp.clickOnAddTestcasesToFreeForm();
		     
		     bp.waitForElement();
		     actual[361]=tp.launchOtherCycles();
		     
		     bp.waitForElement();
		     String cyclename4=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,0 );
		     ...
		     actual[362]=tp.selectCycleInSearch(cyclename4, Build4, Environment4);
		     bp.waitForElement();
		     
		     bp.waitForElement();
		     String PhaseName4=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,1 );
		     actual[363]=tp.selectPhaseInSearch(PhaseName4);
		     bp.waitForElement();
		     
		     String Status4=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning",4 ,18 );
		     actual[364]=tp.filterByStatus(Status4);
		     
		     actual[365]=tp.clickOnGo();
		     
		     actual[366]=tp.validateRetrieveTestcases();
		     bp.waitForElement();
		     
		     actual[367]=tp.clickOnMaintainassignmentsoforiginalschedules();
		     bp.waitForElement();
		     
		     actual[368]=tp.selectAllFreeFormTestCasesPhase();
		     bp.waitForElement();
		     
		     actual[369]=tp.clickOnSaveAndOk();
		     bp.waitForElement();
		     
		     actual[370]=tp.closeFreeFormPage();
		     bp.waitForElement();
		     
		     actual[371]=tp.validateAddtestcaesToFreeForm();
		     bp.waitForElement();
			
		     
		     bp.waitForElement();
		     actual[372]=tp.clickOnAddTestcasesToFreeForm();
		     
		     bp.waitForElement();
		     actual[373]=tp.launchOtherCycles();
		     
		     bp.waitForElement();
		     String cyclename5=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,0 );
		     ...
		     actual[374]=tp.selectCycleInSearch(cyclename5, Build5, Environment5);
		     bp.waitForElement();
		     
		     bp.waitForElement();
		     String PhaseName5=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,1 );
		     actual[375]=tp.selectPhaseInSearch(PhaseName5);
		     bp.waitForElement();
		     
		     String Status5=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning",6 ,18 );
		     actual[376]=tp.filterByStatus(Status5);
		     
		     actual[377]=tp.clickOnGo();
		     
		     actual[378]=tp.validateRetrieveTestcases();
		     bp.waitForElement();
		     
		     actual[379]=tp.clickOnMaintainassignmentsoforiginalschedules();
		     bp.waitForElement();
		     
		     actual[380]=tp.selectAllFreeFormTestCasesPhase();
		     bp.waitForElement();
		     
		     actual[381]=tp.clickOnSaveAndOk();
		     bp.waitForElement();
		     
		     actual[382]=tp.closeFreeFormPage();
		     bp.waitForElement();
		     
		     actual[383]=tp.validateAddtestcaesToFreeForm();
		     bp.waitForElement();
		     
		     
		     bp.waitForElement();
		     actual[384]=tp.clickOnAddTestcasesToFreeForm();
		     
		     bp.waitForElement();
		     actual[385]=tp.launchOtherCycles();
		     
		     bp.waitForElement();
		     String cyclename6=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,0 );
		     ...
		     actual[386]=tp.selectCycleInSearch(cyclename6, Build6, Environment6);
		     
		     bp.waitForElement();
		     String PhaseName6=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "FreeForm",40 ,1 );
		     actual[387]=tp.selectPhaseInSearch(PhaseName6);
		     bp.waitForElement();
		     
		     String Status6=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning",8 ,18 );
		     actual[388]=tp.filterByStatus(Status6);
		     
		     actual[389]=tp.clickOnGo();
		     
		     actual[390]=tp.validateRetrieveTestcases();
		     bp.waitForElement();
		     
		     actual[391]=tp.clickOnMaintainassignmentsoforiginalschedules();
		     bp.waitForElement();
		     
		     actual[392]=tp.selectAllFreeFormTestCasesPhase();
		     bp.waitForElement();
		     
		     actual[393]=tp.clickOnSaveAndOk();
		     bp.waitForElement();
		     
		     actual[394]=tp.closeFreeFormPage();
		     bp.waitForElement();
		     
		     actual[395]=tp.validateAddtestcaesToFreeForm();
		     bp.waitForElement();
			 pp.clickOnLogout();
			 bp.waitForElement();
	    }
		...
		try
		   {
			...
			bp.waitForElement();
				rp= new ReleasePage(driver);
				bp.waitForElement();
				   actual[396]=rp.clickOnTestExecution(); 
				   ...
				   String[] cycleName1=new String[3];
				    ...
				    bp.waitForElement();
				    bp.waitForElement();
					actual[397]=tp.navigateToCycle(cycleName1);
					bp.waitForElement();
		   }
		catch(Exception e)
		{
	...
	public void user_check_the_assignments() throws Throwable {
	    try
	    {
