...
public class Create_Cycle_868174 extends LaunchBrowser
{
	LaunchBrowser lb;
	LoginPage lp;
	ProjectPage pp;
	...
	boolean[] actual=new boolean[10];
	 ...
	 String fileName="Create_Cycle_868174";
	 
	@Given("^user in release page to create project$")
	public void user_in_release_page_to_create_project() throws Throwable 
	{
		try
		   {
	...
	@Given("^create a project with Start and end date$")
	public void create_a_project_with_Start_and_end_date() throws Throwable 
	{
		try
		{
		actual[4]=rp.clickOnTestPlanning();
	    bp.waitForElement();
		 }
		   catch (Exception e) 
			{
	...
	public void create_a_cycle_with_project_startdate_and_End_date() throws Throwable 
	{
		try
		{
		    tl=new TestPlanningPage(driver);
		    actual[5]=tl.clickOnAddTestCycleSymbol();
		    bp.waitForElement();
		    //creating cicle 1
			String cyclename=UNIQUE+Excel_Lib.getData(INPUT_PATH_4, "Create cycle", 51, 0);
			...
			actual[6]=tl.CreateCycle(cyclename, Build, Environment,hide);
			...
			actual[7]=tl.enterStartDatAndEndDate(syear, smonth, sday, eyear, emonth, eday);
			bp.waitForElement();
			
			actual[8]=tl.saveTestCycle();
			bp.waitForElement();
	...
	public void should_able_to_create_cycle() throws Throwable 
	{
		try
		{
		   String cyclename1[]=new String[1];
			cyclename1[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_4, "Create cycle", 51, 0);
			actual[9]=tl.navigateToCycle(cyclename1);
			bp.waitForElement();
