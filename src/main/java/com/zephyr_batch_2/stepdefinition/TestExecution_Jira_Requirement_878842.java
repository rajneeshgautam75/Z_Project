...
public class TestExecution_Jira_Requirement_878842 extends LaunchBrowser{
 ...
 CreateCustomFieldsPage ccp;
	...
	SoftAssert soft=new SoftAssert();
	 ...
	 String fileName="TestExecution_Jira_Requirement_878842";
	 
	@Given("^Manager Launch Defect Admin and click on general configuration and disable requirement-tc flag$")
	public void manager_Launch_Defect_Admin_and_click_on_general_configuration_and_disable_requirement_tc_flag() throws Throwable {
		try
	    {
	...
	public void as_a_Lead_Launch_TestRepository_and_create_a_phase_and_create_testcases() throws Throwable {
		try
		   {
			bp=new BasePage();
		   pp=new ProjectPage(driver);
		   ...
		   String projectName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Normal_Project_1");
	    	 ...
	    	 rp= new ReleasePage(driver);
			   ...
			   tr=new TestRepositoryPage(driver);
				//String releaseName=Excel_Lib.getData(INPUT_PATH_3, "Releases", 6, 0);
				String p_Name1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Map_Jira_Requirement", 4, 1);
				String p_Desc1=Excel_Lib.getData(INPUT_PATH_3, "Map_Jira_Requirement", 4, 2);
	...
	public void as_a_Lead_Launch_Requirements_and_perform_defect_import_operation() throws Throwable {
		try
	    {
	    	rp= new ReleasePage(driver);
			   bp.waitForElement();
	...
	public void user_map_Jira_requirement_to_the_testcase() throws Throwable {
	    ...
	    {	
	    	...
	    	navigation[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3,"Import",4,9);
			...
			field[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Map_Jira_Requirement", 4, 1);
		 	 bp.waitForElement();
		 	 bp.waitForElement();
		 	 bp.waitForElement();
		...
		try
		   {
			...
			bp.waitForElement();
			  ...
			  tp=new TestPlanningPage(driver);
				...
				String cycle=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Map_Jira_Requirement", 4, 0);
	...
	@When("^User create a phase and assign some testcases to tester and some testcases to anyone$")
	public void user_create_a_phase_and_assign_some_testcases_to_tester_and_some_testcases_to_anyone() throws Throwable {
		try
		{
			bp.waitForElement();
			String[] cycle1=new String[1];
			cycle1[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Map_Jira_Requirement", 4, 0);
			bp.waitForElement();
			actual[38]=tp.navigateToCycle(cycle1);
			
			 bp.waitForElement();
			String Phase=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Map_Jira_Requirement", 4, 1);
			actual[39]=tp.addPhaseToCycle(Phase);
			bp.waitForElement();
			String Bulk_Type=Excel_Lib.getData(INPUT_PATH_3, "BulkAssignment", 1, 0);
			actual[40]=tp.bulkAssignment(Bulk_Type);
			bp.waitForElement();
			
			String[] cycle11=new String[1];
			cycle11[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Map_Jira_Requirement", 4, 1);
			bp.waitForElement();
			actual[41]=tp.navigateToCycle(cycle11);
			bp.waitForElement();
			...
			bp.waitForElement();
			actual[42]=tp.selectSingleMultipleTestcase(testCaseNo1);
			bp.waitForElement();
			...
			bp.waitForElement();
			actual[44]=tp.selectSingleMultipleTestcase(testCaseNo2);
			bp.waitForElement();
			
			bp.waitForElement();
			String assignee2=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning", 6, 9);
			actual[45]=tp.assignAllSelected(assignee2);
			bp.waitForElement();
	...
	public void tester_Launch_TestExecution_and_expand_and_Release_and_Cycle_and_select_a_phase() throws Throwable {
		try
		{
			lp=new LoginPage(driver);
	    ...
	    cycleName1[1]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Map_Jira_Requirement",4 ,0 );
	    cycleName1[2]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Map_Jira_Requirement",4 ,1 );
	    bp.waitForElement();
	    tp=new TestPlanningPage(driver);
	    bp.waitForElement();
	    bp.waitForElement();
	...
	@When("^execute testcases to pass/fail/Blocked and link a defect$")
	public void execute_testcases_to_pass_fail_Blocked_and_link_a_defect() throws Throwable {
		try
		{
			bp.waitForElement();
			int[] tcNo1=new int[1];
