...
public class ExecuteStatus_868167 extends LaunchBrowser{
	...
	String fileName="ExecuteStatus_868167";
	...
	public void user_creates_a_phase_and_creates_testcases_with_unique_estimated_time() throws Throwable {
		try{
			String releaseName=Excel_Lib.getData(INPUT_PATH_3, "Releases", 1, 0);
			String p_Name1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "ExecuteStatus", 10, 1);
			String p_Desc1=Excel_Lib.getData(INPUT_PATH_3, "ExecuteStatus", 10, 4);
	...
	public void user_Launches_TestPlanning_and_creates_a_cycle_and_creates_a_phase_by_choosing_the_existing_phase() throws Throwable {
		try
		   {
			bp.waitForElement();
...
//			  rp.clickOnTestPlanning();
			  ...
			  tp=new TestPlanningPage(driver);
				...
				String cycle=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "ExecuteStatus", 10, 0);
				...
				cycle1[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "ExecuteStatus", 10, 0);
				actual[26]=tp.navigateToCycle(cycle1);
				
				bp.waitForElement();
				String Phase=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "ExecuteStatus", 10, 1);
	...
	@When("^User Launches TestExecution and executes testcases in a phase$")
	public void user_Launches_TestExecution_and_executes_testcases_in_a_phase() throws Throwable {
		try
		   {
			   bp.waitForElement();
				rp= new ReleasePage(driver);
				bp.waitForElement();
				   ...
				   String[] cycleName=new String[3];
				    ...
				    cycleName[1]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "ExecuteStatus",10 ,0 );
				    cycleName[2]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "ExecuteStatus",10 ,1 );
				    ...
				    String cycleName22=Excel_Lib.getData(INPUT_PATH_3, "Releases",6 ,0 );
					tp.doubleClickOnCycle(cycleName22);
					bp.waitForElement();
		   }
		catch(Exception e)
		{
	...
	public void user_Launches_TestPlanning_and_selects_the_phase_chooses_the_option_assign() throws Throwable {
		try
		{
			bp.waitForElement();
			rp= new ReleasePage(driver);
...
//		rp.clickOnTestPlanning();
		...
		String cycleName1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "ExecuteStatus",10 ,0 );
		bp.waitForElement();
		actual[36]=tp.doubleClickOnCycle(cycleName1);
	   
	   String[] cycleName=new String[2];
	    cycleName[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "ExecuteStatus",10 ,0 );
	    cycleName[1]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "ExecuteStatus",10 ,1 );
	    bp.waitForElement();
	    bp.waitForElement();
	    bp.waitForElement();
	    bp.waitForElement();
	...
	@When("^User selects the phase which contains testcases and performs the bulk unassign operation$")
	public void user_selects_the_phase_which_contains_testcases_and_performs_the_bulk_unassign_operation() throws Throwable {
		try
	    {
	    	 String[] phaseName=new String[1];
		     phaseName[0]=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "ExecuteStatus",10 ,1 );
		     bp.waitForElement();
		     bp.waitForElement();
			...
			bp.waitForElement();
			actual[41]=tp.assignAllSelected(assignee);
			bp.waitForElement();
	...
	public void user_successfully_checks_the_actual_time_should_be_reset_to_zero() throws Throwable {
		try
	    {
			...
			bp.waitForElement();
			tp.assignAllSelected(assignee1);
			bp.waitForElement();
			tp.goBackToCycle();
	    }
	    catch(Exception e)
