...
public class Map_808598 extends LaunchBrowser {
	...
	public void user_go_to_TestCase_Details_view_and_Maps_a_Requirement() throws Throwable {
	    ...
	    String reqNum[]=new String[1];
	     reqNum[0]=Integer.toString(Excel_Lib.getNumberData(INPUT_PATH_3, "Requirements", 1, 0));
		tr.selectMultipleRequirementFromGrid(reqNum);
