...
public void user_click_on_edit_and_edit_custom_field_of_types_checkbox() throws Throwable
{
	try
	{
		...
		bp.waitForElement();
		tr.editTestCase();
	String text=Excel_Lib.getData(INPUT_PATH_2,"CustomField", 100, 0);
	String longText=Excel_Lib.getData(INPUT_PATH_2,"CustomField", 100, 0);
	String number=Excel_Lib.getData(INPUT_PATH_2,"CustomField", 100, 0);
	String checkBox=Excel_Lib.getData(INPUT_PATH_2,"CustomField", 1, 4);
	String pickupList=Excel_Lib.getData(INPUT_PATH_2,"CustomField", 100 ,5);
	String date=Excel_Lib.getData(INPUT_PATH_2,"CustomField", 100, 0);
