...
//		lp.clickOnLogin();
	...
	public void select_the_first_lead_user_and_assign_the_projects() throws Throwable {
		...
		String[] fullName=lead_User_1.split("\\.");

		 String lead_1=fullName[0]+" "+fullName[1];
		 pp.selectUser(lead_1);
...
//	    bp.checkSelectedProjectCount();
	...
	public void select_the_second_lead_user_and_assign_the_projects() throws Throwable {
		...
		String[] fullName=lead_User_2.split("\\.");

		 String lead_2=fullName[0]+" "+fullName[1];
		 pp.selectUser(lead_2);
	...
	public void select_the_third_lead_user_and_assign_the_projects() throws Throwable {
		...
		String[] fullName=lead_User_3.split("\\.");

		 String lead_3=fullName[0]+" "+fullName[1];
		 pp.selectUser(lead_3);
	...
	public void select_the_fourth_lead_user_and_assign_the_projects() throws Throwable {
		...
		String[] fullName=lead_User_4.split("\\.");

		 String lead_4=fullName[0]+" "+fullName[1];
		 pp.selectUser(lead_4);
	...
	public void select_the_fifth_lead_user_and_assign_the_projects() throws Throwable {
		...
		String[] fullName=lead_User_5.split("\\.");

		 String lead_5=fullName[0]+" "+fullName[1];
		 pp.selectUser(lead_5);
	...
	public void select_the_sixth_lead_user_and_assign_the_projects() throws Throwable {
		...
		String[] fullName=lead_User_6.split("\\.");

		 String lead_6=fullName[0]+" "+fullName[1];
		 pp.selectUser(lead_6);
	...
	public void select_the_first_tester_user_and_assign_the_projects() throws Throwable {
		...
		String[] fullName=tester_User_1.split("\\.");

		 String tester_1=fullName[0]+" "+fullName[1];
		 pp.selectUser(tester_1);
	...
	public void select_the_second_tester_user_and_assign_the_projects() throws Throwable {
		...
		String[] fullName=tester_User_2.split("\\.");

		 String tester_2=fullName[0]+" "+fullName[1];
		 pp.selectUser(tester_2);
	...
	public void select_the_third_tester_user_and_assign_the_projects() throws Throwable {
		...
		String[] fullName=tester_User_3.split("\\.");

		 String tester_3=fullName[0]+" "+fullName[1];
		 pp.selectUser(tester_3);
	...
	public void select_the_fourth_tester_user_and_assign_the_projects() throws Throwable {
		...
		String[] fullName=tester_User_4.split("\\.");

		 String tester_4=fullName[0]+" "+fullName[1];
		 pp.selectUser(tester_4);
