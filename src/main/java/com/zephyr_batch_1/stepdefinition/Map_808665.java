...
public class Map_808665 extends LaunchBrowser {
...
public void user_clicks_on_Import_and_selects_Import_type_as_JIRA() throws Throwable {
	...
	String importTypeNum=Excel_Lib.getData(INPUT_PATH_3, "Import",1 ,5 );
...
public void user_go_to_details_and_performs_mapping() throws Throwable {
	 try
	    ...
	    actual[21]=tr.selectRequirementFromGrids(testCaseNo);
	    bp.waitForElement();
	    bp.waitForElement();
...
//		driver.navigate().refresh();
    ...
    bp.waitForElement();
    bp.waitForElement();
    actual[26]=tr.selectRequirementFromGrids(testCaseNo);
    bp.waitForElement();
    bp.waitForElement();
    req.clickOnSavejirareq.click();
	}
...
//		 actual[15]=tr.addNode(p_Name1,p_Desc1);  
   ...
   // testCaseNo[2]=Integer.toString(Excel_Lib.getNumberData(INPUT_PATH_3, "TestCases",3 ,4 ));
    ...
    bp.waitForElement();
    bp.waitForElement();
    actual[31]=tr.selectRequirementFromGrids(testCaseNo);
    bp.waitForElement();
    bp.waitForElement();
    req.clickOnSavejirareq.click();
	}
...
//		 actual[15]=tr.addNode(p_Name1,p_Desc1);  
   ...
   // testCaseNo[2]=Integer.toString(Excel_Lib.getNumberData(INPUT_PATH_3, "TestCases",3 ,4 ));
    ...
    bp.waitForElement();
    bp.waitForElement();
    actual[36]=tr.selectRequirementFromGrids(testCaseNo);
    bp.waitForElement();
    bp.waitForElement();
    req.clickOnSavejirareq.click();
	}
...
//		
    ...
    bp.waitForElement();
    bp.waitForElement();
    actual[41]=tr.selectRequirementFromGrids(testCaseNo);
    bp.waitForElement();
    bp.waitForElement();
    req.clickOnSavejirareq.click();
	}
...
//	bp.waitForElement();
    ...
    bp.waitForElement();
    bp.waitForElement();
    actual[46]=tr.selectRequirementFromGrids(testCaseNo);
    bp.waitForElement();
    bp.waitForElement();
    req.clickOnSavejirareq.click();
	}
...
//	bp.waitForElement();
    ...
    bp.waitForElement();
    bp.waitForElement();
    actual[51]=tr.selectRequirementFromGrids(testCaseNo);
    bp.waitForElement();
    bp.waitForElement();
    req.clickOnSavejirareq.click();
	}
