...
public class Map_808670 extends LaunchBrowser {
...
//				actual[4]=req.chooseAccessType(accessType);
	...
	public void user_maps_Jira_requirements_to_a_testcase() throws Throwable {
	    ...
	    bp.waitForElement();
	    bp.waitForElement();
	    actual[22]=tr.selectRequirementFromGrids(testCaseNo);
	    bp.waitForElement();
	    bp.waitForElement();
	    ...
	    public void user_Uncheck_the_selected_requirements() throws Throwable {
	    	 try
	    	 {
	    	   ...
	    	   // ep=new ExportPage(driver);
	    	    ...
	    	    bp.waitForElement();
	    	    actual[28]=tr.selectRequirementFromGrids(testCaseNo);
	    	    bp.waitForElement();
