...
public class Map_808661 extends LaunchBrowser {
...
//    tr.selectRequirementFromGrids(testCaseNo)
//    req.selectMultipleRequirementFromGrids(testCaseNo)
    actual[15]= tr.selectRequirementFromGrids(testCaseNo);
    bp.waitForElement();
    bp.waitForElement();
