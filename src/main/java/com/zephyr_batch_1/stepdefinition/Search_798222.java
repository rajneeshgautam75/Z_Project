...
public class Search_798222 extends LaunchBrowser
{
	LaunchBrowser lb;
	LoginPage lp;
	ProjectPage pp;
...
//		   lp.clickOnLogin();
	...
	public void select_the_priority_All_creators_and_all_M_A() throws Throwable 
	{
		...
		creator[0]=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE,"Manager_1");
		creator[1]=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE,"Lead_1");
		creator[2]=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE,"Tester_1");
		creator[3]=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE,"Tester_4");
		creator[4]=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE,"Lead_3");
		creator[5]=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE,"Lead_4");
		creator[6]=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE,"Lead_5");
		creator[7]=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE,"Lead_6");
		creator[8]=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE,"Tester_2");
		creator[9]=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE,"Tester_3");
